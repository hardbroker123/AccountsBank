						...
						<div class="col-md-6">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">填写车辆资产信息</h3>
								</div>
								<div class="panel-body">

									<div class="input-group">
										<div class="input-group-addon">牌照号码</div>
										<select class="form-control" style=width:20%>
											<option  value="option1">京</option>
										</select> 
										<input class="form-control" placeholder="请输入牌照号码" type="text" style="width:80%">
									</div>
									<br>
									<div class="input-group">
										<div class="input-group-addon">所有人</div>
									...
									<br>
									<div class="input-group">
										<div class="input-group-addon">保险到期日</div>
										<input type="text" class="form-control" placeholder="请选择日期" id="test1">
									</div>
									<br>
									<div class="input-group">
