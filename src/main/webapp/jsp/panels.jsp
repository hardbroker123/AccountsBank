						...
						<div class="col-md-6">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">增加联系人信息</h3>
								</div>
								<div class="panel-body">
									<div class="input-group">
										<div class="input-group-addon">与本人关系</div>
									...
									<br>
									<div class="input-group" id="display2">
										<div class="input-group-addon">姓名</div>
										<input class="form-control" placeholder="请输入真实姓名" type="text">
									</div>
									<br>
									<div class="input-group" id="display1">
										<div class="input-group-addon">身份证号码</div>
										<input class="form-control" placeholder="请输入18位身份证号" type="text">
									</div>
									<br>
									<div class="input-group" >
										<div class="input-group-addon">联系手机</div>
										<input class="form-control" placeholder="如：13500000000" type="text">
									</div>
									<br>
									<div class="row">
										<div class="col-md-3"></div>
										<div class="col-md-6">
										<button class="btn btn-primary btn-lg btn-block" type="button" style="width:80%">提交</button>
										</div>
									</div>
								</div>
							<!-- END INPUT GROUPS -->
